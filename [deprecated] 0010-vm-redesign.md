...
- **Status**: deprecated (Part 1 implemented; active VM path retired by [0022](%5Bdeprecated%5D%200022-native-unique-ownership.md)); Part 2 deferred — superseded by [0014](0014-compilation-toolchain-architecture.md) D6
- **Proposed**: 2026-06-03
- **Completed**: 2026-06-08 (Part 1 — `backend/vm` RC/COW value model)

**Current replacement**: [0022 — Native-Only Toolchain and Unique Ownership](%5Bdeprecated%5D%200022-native-unique-ownership.md) for the retired VM execution path; [0014 — Compilation Toolchain Architecture](0014-compilation-toolchain-architecture.md) D6 for the deferred embedded self-host binary direction.
...
### 2026-06-20 — VM path retired by native-only toolchain ([0022](%5Bdeprecated%5D%200022-native-unique-ownership.md))
